...
|---|---|---|---|
|-| Kill Cooldown | 10 - 60 | Cooldown for use Kill |
|-| Kill Range |"Contact" - "Short" - "Normal" - "Long" - "Sniper"| Range for use kill |
|-| Can Kill Cultes Members | Yes / No | If "yes" Sherif can kill Culte member |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Shield Setting |"Protected" - "Reflect"| If "Reflect", Mercenray or Assassin will die if try to kill. |
|-| Protected Player Can See Shield | Yes / No | If "Yes" Protected player see a shield. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Break Time Cooldown | 10 - 180 | Cooldown for use Ability. |
|-| Break Time Duration | 1 - 20 | Duration of Ability. |
...
|-|Settings|Range|Description|
|-| Protect Cooldown | 10 - 180 | Cooldown for use Ability. |
|-| Protect Duration | 1 - 20 | Duration of Ability. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Can use Door Sabotage | "Disable" - "Enable" - "Ghost Only" | Spirit can use Sabotage (only for door). |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Bonus Buzz | "Disable" - "Enable" - "Task End" | Mayor can Use bonus buzz ability. |
|-| Buzz Bonus Cooldown| 5 - 60 | Cooldown for use Ability. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Detection Cooldown| 10 - 60 | Cooldown for use Ability. |
|-| Detection Duration| 5 - 30 | Duration of Ability. |
|-| Foorprint Duration| 1 - 30 | Duration of Footprint mark. |
|-| Foorprint Anonymous| Yes / No | If "yes", footprint was grey color. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Light Cooldown | 10 - 180 | Cooldown for use Ability. |
|-| Light Duration | 1 - 20 | Duration of Ability. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Super Vision Duration | 1 - 20 | Duration of Ability. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Analyz Cooldown | 5- 60 | Cooldown for use Ability. |
|-| Analyz Settings | "Single" - "Round" - "Cooldown" | If "Single", Informant can Check one time par game, if "Round" Ability can use 1 per round. if "cooldown" Unlimited check. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Reporting Time | 1 - 15 | Delay before killer Report the Bait. |
|-| Can Use Vent | Yes / No | Bait can use Vent. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Can Use Admin Color | Yes / No | If "yes" the Ability (admin color) was enabled, only once per game. |
|-| Can Use Vent | Yes / No | if "yes" Mentalist see player-votes colors. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Block vent only 1 per round | Yes / No | if "yes" Ability can une only one time per round. |
|-| Block Vent max Use | 1 - 3 | Max time to use ability per Game. |
|-| Block Vent Cooldown | 10 - 60 | Cooldown for use Ability |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| FakeKill Cooldown | 10 - 180 | Just a cooldown for Troll Soundboard in game |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Both Lovers die | Yes / No | if "Yes" the lovers die when 1 lover has killed. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Convert Cooldown | 5 - 60 | Cooldown for use Ability |
|-| Max Culte Member | 1 - 2 | Max player can be convert to the culte. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Digestion cooldown | 10 - 60 | Cooldown for use Ability |
|-| Cooldown for Eat body | 1 - 20 | Cooldown before eat body. |
|-| Body Eat for Win | 1 - 5 | Cooldown before eat body. |
|-| Can Use Vent | Yes / No | Eater can use Vent. |
|-| Can Drag boddy | Yes / No | Eater can use Ability for Dragg body. |
|-| Blood Remove after Meeting | Yes / No | if "yes" the Blood mark has Removed after the Meeting. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Ressurection Cooldown | 1 - 30 | Cooldown before use the ressurection. |
...
|---|---|---|---|
|-| Kill Cooldown | 10 - 60 | Cooldown for use Kill |
|-| Can Kill shielded Player | Yes / No | If "Yes" Assassin can kill shielded player, but he can steal Ability. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Infect Cooldown | 10 - 120 | Cooldown for Infect a player |
|-| Kill Infected Cooldown | 1 - 60 | Cooldown for use Kill the infected player |
|-| Infected Can See Buff | Yes / No | If "Yes" Infected player see Buff. |
|-| Can Use Vent | Yes / No | Slayer can use Vent. |
|-| Normal kill if Alone | Yes / No | If "Yes", When Slayer as Alone impostor alive, Ability was replace by Normal Kill. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Morph Cooldown | 10 - 180 | Cooldown for use Ability. |
|-| Morph Duration | 1 - 30 | Duration of Ability. |
|-| Can ReUse Scan | Yes / No | If "Yes" Morphling can Re-Use Scan After meeting the player Scanned die. |
|-| Can Use Vent | Yes / No | Morph can use Vent. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Camo Cooldown | 10 - 180 | Cooldown for use Ability. |
|-| Camo Duration | 1 - 30 | Duration of Ability. |
|-| Can Use Vent | Yes / No | Scrambler can use Vent. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Shadow Cooldown | 10 - 180 | Cooldown for use Ability (Shadow). |
|-| Shadow Duration | 1 - 30 | Duration of Ability (Shadow). |
|-| Shadow Disable Camera | Yes / No | if "Yes" during shadow camera has disable. |
|-| Can Create Vent | Yes / No | if "yes" Barghest can create 1 vent per round |
|-| Create vent Cooldown | 10 - 60 | Cooldown for use Ability (Create Vent). |
|-| Can Use Barghest Vent | "Only Barghest" - "All Impostors" - "Impostor If can Use" - "Everyone If can Use" | Who can use the Barghest Vent ! |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Hide Cooldown | 10 - 180 | Cooldown for use Ability. |
|-| Hide Duration | 1 - 30 | Duration of Ability. |
|-| Can Use Vent | Yes / No | Ghost can use Vent. |
...
|-|Settings|Range|Description|
|---|---|---|---|
|-| Charging speed | "x1" - "x2" - "x3" | Amount energy requiered before use Ability. |
|-| Amount energy Spawns | 1 - 30 | Amout energy spawn to the Map |
|-| Can Use Vent | Yes / No | Vandal can use Vent. |
...
|---|---|---|---|
|-| Charging speed | "x1" - "x2" - "x3" | Amount energy requiered before use Ability. |
|-| Number of Kill during meeting | 1 - 10 | Amout time to use Guess Ability |
|-| Only one Try per Meeting | Yes / No | If "yes" Guesser can use one time per meeting Guess Ability. |
|-| Can Use Vent | Yes / No | Guesser can use Vent. |
